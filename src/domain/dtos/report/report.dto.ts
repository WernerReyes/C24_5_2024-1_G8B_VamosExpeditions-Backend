...
const ALLOWED_RESERVATION_TYPES = [
  "Hotel",
  "Flight",
  "Tour",
  "Alojamiento",
...
export class Reportdto {
  ...
  static create(props: { [key: string]: any }): [string?, Reportdto?] {
    const { subject, to, resources, reservationId, description, from } = props;
    ...
    return [
      undefined,
      new Reportdto(subject, to, resources, from, +reservationId, description),
    ];
  }
}
