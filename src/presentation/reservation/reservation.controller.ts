...
export class ReservationController extends AppController {
    ...
    this.reservationService.createReservation(createreservationtDto!)
    ...
    public updateReservation = (req: Request, res: Response) => {
        ...
        this.reservationService.updateReservation(+id, updateReservationDto!)
    ...
    public getReservationsByStatus = (req: Request, res: Response) => {
        const { status } = req.params;
        this.reservationService.getReservationsByStatus(status)
